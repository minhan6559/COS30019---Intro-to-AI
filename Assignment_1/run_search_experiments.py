...
def parse_args():
    ...
    parser.add_argument("--generate", action="store_true", help="Generate test graphs")
    ...
    # New arguments for advanced experiment configuration
    parser.add_argument(
        "--node-counts",
        type=int,
        nargs="+",
    ...
    parser.add_argument(
        "--checkpoint",
        help="Use specific checkpoint (timestamp) for the experiment steps",
    )
    parser.add_argument(
        "--graphs-checkpoint", help="Use specific checkpoint for graph data"
    )
    parser.add_argument(
        "--results-checkpoint", help="Use specific checkpoint for experiment results"
    )
...
def main():
    ...
    if args.run or args.all:
        ...
        # Add new parameters for experiment run configuration
        run_command_args.extend(["--node-counts"] + [str(n) for n in args.node_counts])
